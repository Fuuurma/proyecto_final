...
def tvl_chains_pct_change():
    change_1d = pd.read_csv(r"C:\Users\34633\Desktop\HelloWorld\mis_mierdas\jupyter_Notebook\data_crypto_page\chains_historic_1d_pct_change.csv", index_col='Date')
    change_7d = pd.read_csv(r"C:\Users\34633\Desktop\HelloWorld\mis_mierdas\jupyter_Notebook\data_crypto_page\chains_historic_7d_pct_change.csv", index_col='Date')
    change_30d = pd.read_csv(r"C:\Users\34633\Desktop\HelloWorld\mis_mierdas\jupyter_Notebook\data_crypto_page\chains_historic_30d_pct_change.csv", index_col='Date')
    # today
